    ...
    public partial class OneGraph : UserControl
    {
        ...
        private void GenerateData()
        {
            ...
            for (Int32 idx = 0; idx < ChartSmpNum; idx++)
            {
                ...
                dtRow[0] = ((double)idx / EmVerif.Core.Communication.PublicConfig.SamplingKhz);
        ...
        private void SetChart()
        {
            ...
            chart_FastLine.ChartAreas[0].AxisX.Maximum = ChartSmpNum / EmVerif.Core.Communication.PublicConfig.SamplingKhz;
