namespace EmVerif.Core.Gui
{
    partial class GuiTop
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.publicGraphs1 = new EmVerif.Core.Gui.Graph.PublicGraphs();
            this.publicLoadBar1 = new EmVerif.Core.Gui.Graph.PublicLoadBar();
            this.publicVariableView1 = new EmVerif.Core.Gui.Variable.PublicVariableView();
            this.publicLog1 = new EmVerif.Core.Gui.Log.PublicLog();
